...
def _load_to_gcs():
    BUSINESS_DOMAIN = "netflix"
    location = "us-west1"

    # Prepare and Load Credentials to Connect to GCP Services
    keyfile_gcs = "/opt/airflow/dags/netflix-load-to-gcs.json"
    ...
    file_path = "/opt/airflow/dags/netflix_userbase.csv"
    destination_blob_name = f"{BUSINESS_DOMAIN}/netflix_userbase.csv"
...
def _load_from_gcs_to_bigquery():
    ...
    keyfile_bigquery = "/opt/airflow/dags/netflix-bigquery.json"
    ...
    table_id = f"{project_id}.pim_netflix.netflix"
...
with DAG(
    "netflix_to_bigquery_pipeline",
    default_args=default_args,
    schedule=None,
    tags=["netflix","gcs","bigqurey"],
):
