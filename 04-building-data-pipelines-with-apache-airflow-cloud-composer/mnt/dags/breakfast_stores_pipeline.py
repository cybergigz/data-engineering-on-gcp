...
def _load_stores_to_gcs(dags_folder="/opt/airflow/dags"):
...
def _load_stores_to_bigquery(dags_folder="/opt/airflow/dags"):
...
with DAG(
    ...
    load_stores_to_bigquery = PythonOperator(
        task_id="load_stores_to_bigquery",
        python_callable=_load_stores_to_bigquery,
    )
    
    end = EmptyOperator(task_id="end")

    start >> load_stores_to_gcs  >> load_stores_to_bigquery >> end